...
func (x *RegisterRespone) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x04Auth\x128\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x15.auth.RegisterRespone\x120\n" +
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*RegisterRespone)(nil), // 1: auth.RegisterRespone
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterRespone
